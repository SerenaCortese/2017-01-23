...
public class BordersController {
    ...
    void doCalcolaConfini(ActionEvent event) {
    	...
    	try {
    		...
    		//Aggiorna tendina con stati presenti nel grafo
    		boxNazione.getItems().clear();
    		boxNazione.getItems().addAll(model.getCountries());
    		
    	}catch(NumberFormatException e) {
    		txtResult.appendText("Errore formattazione dell'anno!\n");
    		return;
    	}
    }
    ...
    void doSimula(ActionEvent event) {
    	...
    	if( partenza == null ) {
    		//non ha selezionato nazione o ha premuto simula prima di calcolaConfini
